...
--
-- Host: localhost
-- Waktu pembuatan: 06 Jun 2024 pada 03.00
...
INSERT INTO `reviews` (`review_id`, `item_id`, `user_id`, `rating`, `comment`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `tb_payments` (
  ...
  `kode_booking` int(11) DEFAULT NULL,
...
ALTER TABLE `tb_payments`
  ...
  ADD KEY `kode_booking` (`kode_booking`) USING BTREE;
...
ALTER TABLE `tb_rentals`
  ...
  ADD CONSTRAINT `tb_rentals_ibfk_2` FOREIGN KEY (`rental_id`) REFERENCES `tb_user` (`id_user`);
